...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"topLevelDomain"
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      "vtp_name":"secondLevelDomain"
    },{
      "function":"__v",
  ...
  "tags":[{
      ...
      "vtp_nonInteraction":false,
      "vtp_useDebugVersion":false,
      "vtp_eventCategory":"Authorization",
      "vtp_trackType":"TRACK_EVENT",
...
var hc={},ic=null;hc.o="GTM-N3VX5D";var jc=null,kc="//www.googletagmanager.com/a?id="+hc.o+"&cv=13",lc={},mc={},nc=G.currentScript?G.currentScript.src:void 0;var oc=function(){},pc=function(a){return"function"==typeof a},qc=function(a){return"string"==sa(a)},rc=function(a){return"number"==sa(a)&&!isNaN(a)},sc=function(a){return Math.round(Number(a))||0},tc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},uc=function(a){var b=[];if(na(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},vc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},wc=function(a,b){if(!rc(a)||!rc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
