...
import {register} from '../../api/UserFunction';
...
export default class Signup extends Component {
  ...
  render() {
    ...
    const {email, password, retypePassword, name, username} = this.state;
    ...
    return (
      <View style={container}>
        <TouchableOpacity
          style={backButton}
          onPress={() => {
            navigation.navigate('AuthenticationScreen', {isLogin: false});
          }}>
          {backIcon}
        </TouchableOpacity>
        <TextInput
